      ...
      <div className="flex items-center justify-between px-4 py-2">
        ...
        <div className="flex items-center space-x-2">
          <Tooltip content="Copy" position="daisytooltip-top">
            <button
              className="flex h-6 w-6 items-center justify-center rounded bg-gray-500 bg-none p-1 text-xs"
          ...
          {showExecuteButton && (
            <Tooltip content="Open & Edit" position="daisytooltip-top">
              <button
                className="flex h-6 w-6 items-center justify-center rounded bg-accent bg-none p-1 text-xs"
