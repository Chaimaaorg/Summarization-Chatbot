...
const Toast = ({ id, message, onClose }: ToastProps) => {
  return (
    <div
      id={id}
      className="fixed right-0 top-0 z-50 mb-4 mr-4 mt-4 flex w-full max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400"
      role="alert"
    >
